...
export const labels = {
    selectDealPage: {
      heading: 'Select Deal Type',
      subheading: 'Thanks for trying DealAI! To get started, select a deal below:'
    },
    primaryPartyPage: {
    ...
    secondaryPartyPage: {
      name: 'Their full legal name',
      country: 'Where are they based?',
    }
}
...
export const headings = {
  ...
  primaryPartyPage: {
    heading: "Primary Party Information",
    subheading: "Let's get to know each other! ",
    info: 'Using DealAI as a business or entity? Put those details in.'
  },
  secondaryPartyPage: {
    heading: "Secondary Party Information",
    subheading: "Who's the other guy? ",
    info: 'Leave this for the other person to fill in?'
  }
}
