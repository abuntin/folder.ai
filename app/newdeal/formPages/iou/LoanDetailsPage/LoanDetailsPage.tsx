...
const {
  ...
  repaymentFrequency: repaymentFrequencyLabel,
  loanDate: loanDateLabel,
} = labels;
const {
  ...
  return (
    <Grid container spacing={4} direction="column">
      ...
      <Grid xs>
        <DateInput
          onAccept={(value) =>
            handleChange(null, loanDateKey, value?.toISOString() ?? "")
          }
          value={dayjs(loanDate)}
        />
      </Grid>
      <Grid xs>
      ...
      <Grid xs>
        <DInput
          ...
          value={rate}
          onChange={(e) =>
            handleChange(e, interestKey, { ...interest, rate: e.target.value })
          }
          number
          InputProps={{
            startAdornment: (
      ...
      <Grid xs>
        <ToggleButtonGroup
          ...
          exclusive
          onChange={(e, newVal) =>
            handleChange(e, interestKey, { ...interest, [typeKey]: newVal })
          }
        >
        ...
        {rate !== 0 && (
          <PanDownAnimation>
            <DAutocomplete<FormOptionType>
              ...
              onChange={(e, newVal) =>
                handleChange(e, interestFrequencyKey, newVal ?? undefined)
              }
            />
          </PanDownAnimation>
        )}
      ...
      <Grid xs>
        <DAutocomplete<FormOptionType>
          ...
          onChange={(e, newVal) =>
            handleChange(e, repaymentFrequencyKey, newVal ?? undefined)
          }
        />
      </Grid>
      {helperText !== "" && (
