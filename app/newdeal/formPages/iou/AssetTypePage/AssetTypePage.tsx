...
import { DText, DAutocomplete, DInput, AppearAnimation, CurrencySelect } from 'components'
...
const { amount: amountKey, details: detailsKey, type: typeKey, currency: currencyKey } = keys;
            ...
            <Grid xs>
                {
                    amount !== 0 && (
                        <AppearAnimation>
                            <CurrencySelect value={currency} onChange={(e, newVal) => handleChange(e, currencyKey, newVal ?? '')} />
                        </AppearAnimation>
                    )
                }
            </Grid>
