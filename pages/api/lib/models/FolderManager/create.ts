...
export const createDirectory: PropType<FolderManagerInterface, 'create'> = async (req, res) => {
  ...
  try {
    ...
    console.error(e)
    return res.status(500).json({ data: null, error: e.message ?? 'Unable to create Directory'})
  }
}
